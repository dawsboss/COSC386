        ...
        <header class="header">
                <div class="jumbotron jumbotron-fluid" , style="width: auto; height: auto;">
                        <form action="search.php" style="width:70px; margin-right: 16px; margin-top:6px;">
                                <input type="submit" class="btn btn-outline-secondary ml-2" value="Back">
                        </form>
                        <div class="container">
                                <div class="row">
                                        <div class="col">
        ...
        <div class="container">
                <div class="row justify-content-md-center">
                        <div class="dropdown text-center">
                                <form method="post">
                                        <select class="btn btn-outline-secondary dropdown-toggle" type="button" aria-haspopup="true" aria-expanded="false" name="table" id="table">
