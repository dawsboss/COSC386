...
<script>
var dataFromBackEnd = <?php echo json_encode($_SESSION['user']);?>;
document.getElementById("demo5").innerHTML = dataFromBackEnd['Name'];
document.getElementById("demo6").innerHTML = dataFromBackEnd['Name']+' | '+dataFromBackEnd['Email'];
</script>
